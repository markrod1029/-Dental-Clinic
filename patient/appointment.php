                ...
                <table class="table table-striped table-bordered" id="myTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT 
                                ...
                                WHERE appointment_table.patient_id = ?";
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="crud/cancel_appointment.php?id=<?php echo htmlspecialchars($row["appointment_id"]); ?>" 
                                        onclick="return confirm('Are you sure you want to cancel this appointment?')"  
                                        class="btn btn-danger btn-sm cancel_appointment" 
                                        data-id="<?php echo htmlspecialchars($row["appointment_id"]); ?>">
