...
$id = $_SESSION['doctor'];
$query = "SELECT status, COUNT(*) as count FROM appointment_table WHERE YEAR(date) = '$year' AND doctor_id = '$id' GROUP BY status";
        ...
        <div class="col-md-3">
            <div class="card shadow mb-4 border-left-primary">
                <div class="card-body d-flex align-items-center">
                    <i class="fas fa-calendar-check fa-3x text-primary me-3"></i>
