	<?php
		...
		if(isset($_POST['submit'])){
			...
			$insert = "INSERT INTO patient_table(patient_id, patient_email_address, patient_photo, patient_password, patient_first_name, patient_last_name, patient_date_of_birth, patient_gender,  patient_address,  patient_phone_no, patient_maritial_status,  added_on) 
			VALUES ('Available', '$patient_email_address', '$location', '$patient_password', '$patient_first_name', '$patient_last_name', '$patient_date_of_birth', '$patient_gender', '$patient_address', '$patient_phone_no',  '$patient_maritial_status', NOW())";
